...
/**
 * Silently ping /api/warmup on page load.
 * This endpoint wakes BOTH the Node backend AND the Python RAG service
 * (which also sleeps on Render free tier) before the user hits "Load Repo".
 */
